            ...
            <div className="relative">
              <div className="rounded-2xl overflow-hidden"
                ...
                <div className="flex items-center gap-3 px-4 pt-3.5">
                  <span className="text-[10px] font-medium uppercase tracking-wider select-none" style={{ color: "rgba(255,255,255,0.22)" }}>Modo</span>
                  <div className="flex items-center rounded-full px-0.5 py-0.5" style={{ backgroundColor: "rgba(255,255,255,0.06)" }}>
                    <button onClick={() => setResponseMode("normal")}
                      className="relative px-3 py-1 text-[11px] font-semibold rounded-full transition-all duration-200">
                      {responseMode === "normal" ? (
                        <span className="absolute inset-0 rounded-full" style={{ background: "var(--primary)", boxShadow: "0 2px 10px rgba(16,163,127,0.4)" }} />
                      ) : null}
                      <span className="relative z-10 flex items-center gap-1.5" style={{ color: responseMode === "normal" ? "white" : "var(--text-tertiary)" }}>
                        <svg className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                    ...
                    <button onClick={() => setResponseMode("deep")}
                      ...
                      <span className="relative z-10 flex items-center gap-1.5" style={{ color: responseMode === "deep" ? "white" : "var(--text-tertiary)" }}>
                        <svg className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    className="shrink-0 p-2 rounded-full transition-all hover:bg-white/10 active:scale-90 disabled:opacity-30"
                    style={{ color: "var(--text-tertiary)" }}
                    title="Adjuntar">
                ...
                <div className="flex items-center gap-2 px-3 pb-3">
                  ...
                  <button
                    ...
                    className="shrink-0 w-9 h-9 rounded-full flex items-center justify-center transition-all hover:scale-105 active:scale-90 disabled:opacity-30"
                    style={{ background: "linear-gradient(135deg, var(--primary), #0d8b6a)", color: "white", boxShadow: "0 3px 14px rgba(16,163,127,0.45)" }}>
