...
export default function ChatInterface({ userId }: { userId: string }) {
  ...
  const [weeklyLimit] = useState(1000);
        ...
        <div className="absolute inset-0 z-40 flex">
          ...
          <aside className="w-72 h-full flex flex-col" style={{ backgroundColor: "var(--surface)", borderLeft: "1px solid var(--border)" }}>
            <div className="flex items-center justify-between p-4 border-b" style={{ borderColor: "var(--border)" }}>
              ...
              <button onClick={() => setSidebarOpen(false)} className="p-1" style={{ color: "var(--text-secondary)" }}>
            ...
            <div className="flex-1 overflow-y-auto p-3">
              ...
              <p className="text-xs font-medium px-3 py-2 mb-1" style={{ color: "var(--text-secondary)" }}>
                Recientes
              </p>
      ...
      <header className="h-14 flex items-center justify-between px-4 border-b shrink-0"
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            ...
            >
              <div className="w-6 h-6 rounded-full flex items-center justify-center text-xs font-medium" style={{ backgroundColor: "var(--primary)", color: "white" }}>
                U
              </div>
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {messages.length === 0 && !loading ? (
          <div className="flex flex-col items-center justify-center h-full px-4">
            <div className="text-center max-w-lg">
              ...
              <p className="text-base mb-2" style={{ color: "var(--text-secondary)" }}>
                {remaining > 0
                  ? activeConv ? "Escribe algo para continuar" : "Selecciona una conversación o inicia una nueva"
          ...
          <div className="flex items-center justify-center h-full">
            <div className="flex items-center gap-2" style={{ color: "var(--text-secondary)" }}>
              <div className="w-5 h-5 border-2 rounded-full border-t-transparent animate-spin" style={{ borderColor: "var(--accent)", borderTopColor: "transparent" }} />
              ...
              <div className="flex justify-start">
                <div className="px-4 py-3 rounded-2xl text-sm" style={{ backgroundColor: "var(--surface)", color: "var(--text-secondary)", border: "1px solid var(--border)" }}>
                  <span className="inline-flex items-center gap-2">
                    <div className="w-4 h-4 border-2 rounded-full border-t-transparent animate-spin" style={{ borderColor: "var(--accent)", borderTopColor: "transparent" }} />
                    Escribiendo...
                  </span>
                </div>
              </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="relative">
            ...
            {!activeConv && (
              <button
                onClick={startNewConversation}
                className="absolute -top-10 left-1/2 -translate-x-1/2 flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-colors"
                style={{ backgroundColor: "var(--primary)", color: "white" }}
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
            ...
            <div className="flex items-end gap-2 p-2 rounded-2xl"
              ...
              <button
                ...
                className="p-2 rounded-xl transition-opacity shrink-0"
                style={{ backgroundColor: "var(--primary)", color: "white" }}
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
